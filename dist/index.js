...
const makeDynamicStyles = (wrap, targetSpace, identity, isBackground) => {
	if (colorConvert === undefined) {
		colorConvert = __nccwpck_require__(630);
	}
...
const cssKeywords = __nccwpck_require__(237);
...
const conversions = __nccwpck_require__(347);
const route = __nccwpck_require__(413);
...
const stripAnsi = __nccwpck_require__(968);
const isFullwidthCodePoint = __nccwpck_require__(425);
const emojiRegex = __nccwpck_require__(681);
...
const ansiRegex = __nccwpck_require__(775);
...
const stringWidth = __nccwpck_require__(588);
const stripAnsi = __nccwpck_require__(968);
const ansiStyles = __nccwpck_require__(141);
...
const yargs = __nccwpck_require__(540);
...
const stringWidth = __nccwpck_require__(588);
const stripAnsi = __nccwpck_require__(968);
const wrap = __nccwpck_require__(574);
function ui(opts) {
    return cliui(opts, {
        stringWidth,
        stripAnsi,
...
const {Yargs, processArgv} = __nccwpck_require__(59);
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(__nccwpck_require__.s = 333);
